            ...
            <div class="card">
              ...
              <div class="space-y-4 p-4 sm:p-5 mb-0">
                <div class="avatar mt-1.5 h-20 w-36 upk border">
                  <img  id="img-preview" class="mask is-" src="{{ url($user_data->image) }}" alt="avatar" style="object-fit:contain;">
              ...
              <div class="space-y-4 p-4 sm:p-5">
                <label class="block">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        >Text</option>
                        <option value="email"
                        @if ($user_data->input_type=="email")
                        selected
                        @else
                        @endif
                        >Email</option>
                        <option value="phone"
                        @if ($user_data->input_type=="phone")
                        selected
                        @else
                        @endif
                        >Phone</option>
                        <option value="number"
                        @if ($user_data->input_type=="number")
                        selected
                        @else
                        @endif
                        >Number</option>
